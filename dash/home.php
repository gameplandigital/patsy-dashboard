                        ...
                        <div class="widget-tabs-list">
                            ...
                            <div class="tab-content tab-custom-st">
                                <div id="home" class="tab-pane fade in active">
                                    <div class="tab-ctn">
                                        <?php
                                        echo"<p>Good day! This is <b>{$urow['firstname']}</b> from AIRCAST. Can you direct me to <b>{$crow['middlename']}</b> marketing dept. please? Thank you. (30 secs)</p>";
                                        ?>
                                        <br>
                                        <p class="tab-mg-b-0">
                                         <?php  
                                        echo"I'm calling <b>{$crow['middlename']}</b> to remind him or her about our product offer which we sent last week. 
                                        Can you put me through please? Thank you and may i ask for you name? Thank you (operator name), appreciate it. (30 sec)";
                                        ?>                                     
                                        </p>
                                        <br>
                                        <p class="tab-mg-b-0">
                                        <?php    
                                        echo"Am i talking to <b>{$crow['middlename']}</b> now? Great! The reason for our call today is to schedule a 30-minute with you and your team. 
                                        Our company has a network of LED billboard display and knowing the nature of your business, you might be interested to 
                                        have your brand be present in (Convenience Store,Fitness Center,Health Clinics,BPO's and University). What do you think?";
                                        ?>    
                                        </p>
                                        <br>
                                        <p class="tab-mg-b-0">
                                        <?php  
                                        echo"I agree with you, this solution might not be suitable for you. 
                                        But what if i can give you free 10 days of display exposure in 10 different sites. would you agree to meet us for a quick meeting on (Meeting Schedule Table). 
                                        Give us 30 minutes of your time, then i can arrange the free 10-day trial for you. What's your email so i can send the invite now? (1 min)";
                                        ?>  
                                        </p>
                                        <br>
                                        <p class="tab-mg-b-0">
                                        <?php 
                                        echo"Awesome choice <b>{$crow['middlename']}</b>. Give me a minute, 
                                        i'll just book your free trial and the meeting invite on (Meeting invite schedule). (Mute for 15 seconds) Hi ma'am/sir <b>{$crow['middlename']}</b>, 
                                        I already sent the invite along with the free trial confirmation. Once you have accepted the invite, 
                                        our free trial request will be official and our Customer Experience team will be meeting you on (Meeting Invite Schedule) to discuss the details. 
                                        Thank you and have a great day. (1 min)";
                                        ?>
                                        </p>
                                        <br>
                                    </div>
